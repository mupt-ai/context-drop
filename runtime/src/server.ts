...
interface TaskRecord { id: string; runId: string; routerId: string; chatId: string; task: string; reportCapability: string; createdAt: string; status: "launching" | "running" | "launch_failed"; launchError?: string; authorizationId?: string; authorizedAction?: SensitiveAction; authorizedScope?: string; authorizationExpiresAt?: string }
