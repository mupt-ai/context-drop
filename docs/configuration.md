...
Casual or unrelated follow-ups always reach the persistent router. There is no terminal steering; if the router decides a follow-up merits work it safely launches a new worker.
